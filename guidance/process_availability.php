...
if ($success ) {
    ...
    $sql = "INSERT INTO availability (Monday_timeIn, Monday_timeOut, Tuesday_timeIn, Tuesday_timeOut, Wednesday_timeIn, Wednesday_timeOut, Thursday_timeIn, Thursday_timeOut, Friday_timeIn, Friday_timeOut)
            VALUES ('$mondayTimeIn', '$mondayTimeOut', '$tuesdayTimeIn', '$tuesdayTimeOut', '$wednesdayTimeIn', '$wednesdayTimeOut', '$thursdayTimeIn', '$thursdayTimeOut', '$fridayTimeIn', '$fridayTimeOut')";
